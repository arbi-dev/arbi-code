                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[300px]">
                    {isSmartContextEnabled ? (
                      <p>
                        With Smart Context, ARBI Code uses the most relevant
                        files as context.
                      </p>
                    ) : (
                      <p>By default, ARBI Code uses your whole codebase.</p>
                    )}
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ...
            {contextPaths.length > 0 ? (
              ...
              <div className="rounded-md border border-dashed p-4 text-center">
                <p className="text-sm text-muted-foreground">
                  {isSmartContextEnabled
                    ? "ARBI Code will use Smart Context to automatically find the most relevant files to use as context."
                    : "ARBI Code will use the entire codebase as context."}
                </p>
              </div>
            )}
          </TooltipProvider>
