...
function formatSettingsLines(settings: UserSettings | null): string {
  ...
  return [
    ...
    `- ARBI Code Pro Enabled: ${settings.enableDyadPro ?? "n/a"}`,
...
- ARBI Code Version: ${debugInfo.dyadVersion}
...
`;
  ...
  const renderMainScreen = () => (
    ...
    >
      <DialogHeader>
        <DialogTitle>Need help with ARBI Code?</DialogTitle>
      </DialogHeader>
      <DialogDescription>
      ...
      <div className="flex flex-col w-full mt-4 space-y-5">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <div className="border rounded-lg p-4 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Includes error logs to troubleshoot non-AI issues with ARBI Code
      ...
      >
        ...
        <div className="space-y-2 overflow-y-auto flex-grow mt-4">
          ...
          <ReviewDetailsSection title="System Information" mono={false}>
            <p>ARBI Code Version: {debugBundle.system.dyadVersion}</p>
